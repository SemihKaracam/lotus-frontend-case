...
//         <div className={`p-6 flex flex-col items-center rounded-xl shadow-lg transform transition-all hover:scale-105 duration-300`}>
...
const Dashboard = () => {
  ...
  if (status === 'loading') {
    return (
      <div className="min-h-screen p-6 font-sans flex items-center justify-center bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100">
        <div className="flex flex-col items-center">
          {/* Spinner */}
          <div className="w-12 h-12 border-4 border-indigo-500 border-t-transparent rounded-full animate-spin mb-4"></div>
          <h2 className="text-xl font-semibold">Veriler yükleniyor...</h2>
  ...
  return (
    <div className={`min-h-screen p-6 font-sans bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100`}>
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-2xl w-full text-indigo-500 text-center font-bold">Dashboard</h1>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        {/* Departman Dağılımı (Pie Chart) */}
        <div className={`p-6 rounded-xl shadow-lg`}>
          <h3 className="text-xl font-semibold text-center pb-6">Departmanlara Göre Çalışan Dağılımı</h3>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
                data={departmentData}
